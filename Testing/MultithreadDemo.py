...
import Demos.ConsumptionSaving.ConsumerParameters as Params # Parameters for a consumer type
import Demos.ConsumptionSaving.ConsIndShockModel as Model # Consumption-saving model with idiosyncratic shocks
